...
transform_test_functions_clause(_TestSuiteGenerator = setup, {cons, L1,
    ...
    TransformedTestSuiteBeforeClause = transform_clause_before("BEFORE", TestSuiteBeforeClause, ModuleName, FunName, undefined, false),
    TransformedTestSuiteAfterClause = transform_clause_after("AFTER", TestSuiteAfterClause, ModuleName, FunName, undefined, false),
